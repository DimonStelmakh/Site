...
<?php require 'header.php';?>
    <div class="banner">
        ...
        <div class="banner_images">
            <img class="banner_image" src="assets/images/banner_images/1.png" alt="" />
    ...
    <section>
        <h2 class="h2">Найпопулярніші комплектації</h2>
        ...
        <h2 class="h2 with_line_above">Акційні комплектації</h2>
        <div class="tabs_block">
            <div class="tab">
                <img class="intab_picture" src="assets/images/template_cut_lt.png" alt="" />
